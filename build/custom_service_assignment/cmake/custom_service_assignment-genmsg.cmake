...
get_filename_component(_filename "/home/bhaswanth/catkin_ws/src/custom_service_assignment/srv/custom_server.srv" NAME_WE)
add_custom_target(_custom_service_assignment_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "custom_service_assignment" "/home/bhaswanth/catkin_ws/src/custom_service_assignment/srv/custom_server.srv" ""
)
...
_generate_srv_cpp(custom_service_assignment
  "/home/bhaswanth/catkin_ws/src/custom_service_assignment/srv/custom_server.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/custom_service_assignment)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/custom_service_assignment\")")
  # install generated code
  install(
