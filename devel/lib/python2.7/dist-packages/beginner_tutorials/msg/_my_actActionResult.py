...
"""autogenerated by genpy from beginner_tutorials/my_actActionResult.msg. Do not edit."""
import codecs
import sys
...
class my_actActionResult(genpy.Message):
  _md5sum = "2a42918724c567b048b06f7ef1de0d8c"
  _type = "beginner_tutorials/my_actActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','beginner_tutorials/my_actResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(my_actActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = beginner_tutorials.msg.my_actResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = beginner_tutorials.msg.my_actResult()
