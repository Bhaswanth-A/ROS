...
(cl:in-package ros_practice-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <add_two_int-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_two_int-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_practice-srv:<add_two_int-request> is deprecated: use ros_practice-srv:add_two_int-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <add_two_int-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_practice-srv:a-val is deprecated.  Use ros_practice-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <add_two_int-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_practice-srv:b-val is deprecated.  Use ros_practice-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_two_int-request>)))
  ...
  "ros_practice/add_two_intRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_two_int-request)))
  "Returns string type for a service object of type 'add_two_int-request"
  "ros_practice/add_two_intRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <add_two_int-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_two_int-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_practice-srv:<add_two_int-response> is deprecated: use ros_practice-srv:add_two_int-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <add_two_int-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_practice-srv:sum-val is deprecated.  Use ros_practice-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_two_int-response>)))
  ...
  "ros_practice/add_two_intResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_two_int-response)))
  "Returns string type for a service object of type 'add_two_int-response"
  "ros_practice/add_two_intResponse")
