...
bool operator==(const ::tum_ardrone::SetReferenceRequest_<ContainerAllocator1> & lhs, const ::tum_ardrone::SetReferenceRequest_<ContainerAllocator2> & rhs)
{
  return lhs.x == rhs.x &&
    lhs.y == rhs.y &&
    lhs.z == rhs.z &&
