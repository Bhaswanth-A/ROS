...
bool operator==(const ::tum_ardrone::SetInitialReachDistanceResponse_<ContainerAllocator1> & lhs, const ::tum_ardrone::SetInitialReachDistanceResponse_<ContainerAllocator2> & rhs)
{
