...
#if defined(_WIN32) && defined(PTAM_IDLE)
  #undef PTAM_IDLE
#endif
#if defined(_WIN32) && defined(PTAM_INITIALIZING)
  #undef PTAM_INITIALIZING
#endif
#if defined(_WIN32) && defined(PTAM_LOST)
  #undef PTAM_LOST
#endif
#if defined(_WIN32) && defined(PTAM_GOOD)
  #undef PTAM_GOOD
#endif
#if defined(_WIN32) && defined(PTAM_BEST)
  #undef PTAM_BEST
#endif
#if defined(_WIN32) && defined(PTAM_TOOKKF)
  #undef PTAM_TOOKKF
#endif
#if defined(_WIN32) && defined(PTAM_FALSEPOSITIVE)
  #undef PTAM_FALSEPOSITIVE
#endif
...
bool operator==(const ::tum_ardrone::filter_state_<ContainerAllocator1> & lhs, const ::tum_ardrone::filter_state_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.dyaw == rhs.dyaw &&
    lhs.scale == rhs.scale &&
    lhs.ptamState == rhs.ptamState &&
    lhs.scaleAccuracy == rhs.scaleAccuracy &&
    lhs.droneState == rhs.droneState &&
